...
class UpdateProjectTask extends Component {
    ...
    onSubmit(e) {
        ...
        this.props.addProjectTask(updateTaskItem, this.props.history);
    }
                    ...
                    <div className="row">
                        <div className="col-md-8 m-auto">
                            ...
                            <form onSubmit={this.onSubmit}>
                                ...
                                <div className="form-group">
                                    <textarea className="form-control form-control-lg" placeholder="Acceptance Criteria" value={this.state.acceptanceCriteria} onChange={this.onChange} name="acceptanceCriteria"></textarea>
                                </div>
                                <div className="form-group">
